/* globals CPLocalStorage */
"use strict";
var RememberScroll = {
    init: function() {
        this._scrollToSavedPosition(),
        this._onUnloadStoreScrollPosition()
    },
    _scrollToSavedPosition: function() {
        var e = CPLocalStorage.getItem(this._getScrollPositionKey());
        e !== undefined && window.scrollTo(0, e),
        CPLocalStorage.removeItem(this._getScrollPositionKey())
    },
    _onUnloadStoreScrollPosition: function() {
        ...
        window.onunload = function() {
            ...
            CPLocalStorage.setItem(e._getScrollPositionKey(), t.scrollTop)
        }
    },
